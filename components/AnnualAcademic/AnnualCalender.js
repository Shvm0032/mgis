...
export default function AnnualCalender() {
  return (
    <section
      className="relative pt-20 pb-24 px-4 sm:px-6 bg-cover bg-center bg-no-repeat"
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="bg-white border border-gray-200 shadow-xl rounded-lg overflow-hidden p-6 md:p-8 flex flex-col md:flex-row gap-6 md:gap-8">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-start space-y-4 md:space-y-5">
            ...
            <div className="w-16 sm:w-20 h-1 bg-[#D70F40] rounded-full"></div>
