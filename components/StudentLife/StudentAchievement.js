...
export default function StudentAchievement() {
  const allImages = [
    "/Assets/studentachievement/achi-1.jpg",     
    "/Assets/studentachievement/achi-2.jpg",     
    "/Assets/studentachievement/achi-3.jpg",     
    "/Assets/studentachievement/achi-4.jpg",     
    "/Assets/studentachievement/achi-5.jpg",     
    "/Assets/studentachievement/achi-6.jpg",     
    "/Assets/studentachievement/achi-7.jpg",     
    "/Assets/studentachievement/achi-8.jpg",     
    "/Assets/studentachievement/achi-9.jpg",     
    "/Assets/studentachievement/achi-10.jpg",     
    "/Assets/studentachievement/achi-11.jpg",     
    "/Assets/studentachievement/achi-12.jpg",     
    "/Assets/studentachievement/achi-13.png",     
    "/Assets/studentachievement/achi-14.png",     
  ...
  return (
    <section className="py-16 px-4 sm:px-6 bg-[#ECECEC]">
      ...
      <div className="text-center mb-8">
        ...
        <div className="w-30 sm:w-24 h-[3px] bg-[#D2093C] mx-auto mt-3"></div>
      </div>
